...
var skPlayer = function () {
    function skPlayer(option) {
        ...
        if (this.type === 'file') {
            ...
            Util.ajax({
                url: baseUrl + 'artist?id=' + this.music,
                beforeSend: function beforeSend() {
                    console.log('SKPlayer正在努力的拉取歌单 ...');
                },
                success: function success(data) {
            ...
            Util.ajax({
                url: baseUrl + 'song/search?key=' + this.music,
                beforeSend: function beforeSend() {
                    console.log('SKPlayer正在努力的拉取歌单 ...');
                },
                success: function success(data) {
    ...
    _createClass(skPlayer, [{
        ...
        value: function init() {
            ...
            if (this.type === 'cloud' || this.type === 'artist' || this.type === 'keywords') {
                Util.ajax({
        ...
        value: function switchMusic(index) {
            ...
            if (this.type === 'file') {
                ...
                this.play();
            } else if (this.type === 'cloud' || this.type === 'artist' ||this.type === 'keywords') {
                Util.ajax({
...
$('.qq').click(player.next);
$('.github').click(player.prev);
